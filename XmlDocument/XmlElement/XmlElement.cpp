...
DocElement::DocElement(std::shared_ptr<AbstractXmlElement> pRoot) 
{
  ...
  pDecl->addAttrib("encoding", "UTF-8");
...
//-------< get children for tagged elements >-----------------------
...
//-----------< get attributes for tagges elements  >------------
...
//-----< generate xml for comment element   >--------------
...
//------------< Get attributes for Processing Elements >--------------
std::vector<std::pair<std::string, std::string>> ProcInstrElement::getAttributes()
{
	return attribs_;
}

//----< generate xml string for declaration element >-------------------------------
...
//----< add attribute to XmlDeclarationElement >-----------------------------------
...
//----< remove attribute from XmlDeclarationElement >------------------------------
...
//-----------< get attributes from XMLDeclaration elements >--------------------
