...
namespace XmlProcessing
{
  ...
  inline std::vector<std::shared_ptr<AbstractXmlElement>> AbstractXmlElement::children() { std::vector<std::shared_ptr<AbstractXmlElement>> v; return v; };
  inline std::vector<std::pair<std::string, std::string>> AbstractXmlElement::getAttributes() { std::vector<std::pair<std::string, std::string>> v; return v; };
